...
#include <memory>
#include "../../FootballClub/InfoNotes/Note.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Note_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Note_t qt_meta_stringdata_Note = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_Note[] = {
...
Q_CONSTINIT const QMetaObject Note::staticMetaObject = { {
    ...
    qt_meta_stringdata_Note.offsetsAndSizes,
    qt_meta_data_Note,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Note_t,
        // Q_OBJECT / Q_GADGET
